...
class LandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create land" do
    assert_difference('Land.count') do
      post lands_url, params: { land: { area: @land.area, customer_id: @land.customer_id, land_type: @land.land_type } }
    end
  ...
  test "should update land" do
    patch land_url(@land), params: { land: { area: @land.area, customer_id: @land.customer_id, land_type: @land.land_type } }
