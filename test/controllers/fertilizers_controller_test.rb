...
class FertilizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fertilizer" do
    assert_difference('Fertilizer.count') do
      post fertilizers_url, params: { fertilizer: { amount: @fertilizer.amount, date: @fertilizer.date, f_type: @fertilizer.f_type, price: @fertilizer.price } }
    end
  ...
  test "should update fertilizer" do
    patch fertilizer_url(@fertilizer), params: { fertilizer: { amount: @fertilizer.amount, date: @fertilizer.date, f_type: @fertilizer.f_type, price: @fertilizer.price } }
